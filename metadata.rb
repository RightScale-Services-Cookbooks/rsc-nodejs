...
recipe "rsc-nodejs::npm_start", "run npm start on destination path" 
recipe "rsc-nodejs::npm_stop", "run npm stop on destination path" 
recipe "rsc-nodejs::npm_restart", "run npm restart on destination path" 
